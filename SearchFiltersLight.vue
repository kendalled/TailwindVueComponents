<template>
  <transition name="slide">
    <section v-if="show" class="bg-gray-800 xl:w-72 border-r">
      <div class="flex justify-between px-4 py-3 xl:hidden">
        <div class="relative max-w-xs w-full">
          ...
          <input class="block w-full bg-gray-900 focus:outline-none focus:bg-white focus:text-gray-200 text-gray-800 rounded-lg pl-10 pr-4 py-2" placeholder="Search by keywords">
        </div>
        <button
          type="button"
        ...
        >
          ...
          <span class="ml-1 text-gray-800 font-medium">Filters</span>
        </button>
      </div>
      <form :class="{ 'hidden': !isOpen, 'block': isOpen }" class="xl:block xl:h-full xl:flex xl:flex-col xl:justify-between">
        <div class="lg:flex xl:block xl:overflow-y-auto">
          ...
          <div class="px-4 pt-3 pb-5 border-t lg:w-1/3 xl:border-t-0 xl:w-full">
            <div class="flex flex-wrap -mx-2">
              ...
              <label class="block w-1/2 px-2 sm:w-1/4 lg:w-1/2">
                <span class="text-sm font-semibold text-gray-700">Material</span>
                <select class="mt-1 form-select block w-full shadow focus:bg-gray-200">
        ...
        <!-- <div class="px-4 py-4 border-t border-gray-900 lg:w-1/3 lg:border-l xl:w-full">
          ...
          <div class="sm:flex sm:-mx-2 sm:flex-wrap">
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              ...
              <span class="ml-2 text-gray-800">Modern</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="pool">
              <span class="ml-2 text-gray-800">Casual</span>
            </label>
            <label class="mt-3 flex items-center sm:w-1/4 sm:px-2 lg:w-1/2 xl:w-full">
              <input class="form-checkbox bg-gray-900 focus:bg-gray-700" type="checkbox" name="beach">
              <span class="ml-2 text-gray-800">Classic</span>
            </label>
          </div>
        </div> -->
        </div>
        <div class="bg-gray-300 px-4 py-4 sm:text-right">
          <button class="block w-full sm:w-auto sm:inline-block bg-blue-600 hover:bg-blue-800 transition-bg font-semibold text-gray-100 px-4 py-2 rounded-lg xl:block xl:w-full">
            Apply Filter(s)
          </button>
        </div>
      </form>
